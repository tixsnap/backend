...
export const authRouter = () => {
  ...
  router.post("/register",validateForms(registerSchema), authController.registerCustomer);
  router.post("/login", validateForms(loginSchema), authController.loginCustomer);
